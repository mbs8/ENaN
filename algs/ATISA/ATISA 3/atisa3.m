...
data = load ('segmentation.txt');
training = data(:, 2:size(data, 2));
classTraining = data(:, 1); %classes da bd diabetes na última coluna
...
z = one_by_class (thr_idx, Tf_class, 6); %db segmentation tem 6 classes
Tf(z, c) = 1;
